...
namespace MetroDemo
{
    public partial class MainWindow
    {
        ...
        private void LaunchMetwoWindowDialogDemo(object sender, RoutedEventArgs e)
        {
            var dialog = new WindowDialogDemo {Title = "Metro Window Dialog"};
            var result = dialog.ShowDialog();
            ShowWindowDialogResult(result);
        }

        private async void ShowWindowDialogResult(bool? result)
        {
            await this.ShowMessageAsync("Metro Window Dialog", "Returned " + result);
        }
